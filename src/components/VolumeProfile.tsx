      ...
      <div className={`relative bg-white/5 dark:bg-neutral-800/50 backdrop-blur border border-white/10 dark:border-neutral-700 rounded-lg mobile:rounded-xl p-3 mobile:p-4 lg:p-5 transition-all duration-300 hover:bg-white/8 hover:border-white/20 hover:shadow-lg hover:shadow-blue-500/5 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="grid grid-cols-1 tablet:grid-cols-2 gap-4 mobile:gap-6 items-center">
          ...
          <div className="group order-1 tablet:order-1">
            <div className="relative h-28 mobile:h-32 tablet:h-40 rounded-lg overflow-hidden border border-white/20 bg-gradient-to-br from-purple-900/20 to-green-900/20 hover:border-white/30 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10">
              <Image
                src="https://images.pexels.com/photos/7948043/pexels-photo-7948043.jpeg"
                alt="Volume Profile - Volume Analysis Tools"
                fill
              ...
              {/* Floating badge */}
              <div className="absolute top-2 mobile:top-4 left-2 mobile:left-4 bg-purple-600/90 backdrop-blur text-white px-2 mobile:px-3 py-1 rounded-full text-xs font-medium">
                Volume-at-Price
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 mobile:space-y-4 tablet:space-y-6 order-2">
            <div>
              ...
              <p className="text-xs mobile:text-sm text-neutral-300 dark:text-neutral-200 leading-relaxed mb-3 mobile:mb-4">
                Volume Profile displays trading activity over a specified time period at various price levels. It helps identify areas of high and low trading activity, revealing where the most volume was traded.
              </p>
            </div>
          </div>
        </div>
