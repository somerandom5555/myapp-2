      ...
      <div className="mx-auto w-full max-w-6xl grid gap-10 lg:grid-cols-2 items-center">
        ...
        <section className="order-1 lg:order-2 w-full max-w-md justify-self-center">
          <div className="text-center mb-4">
            ...
            <h1 className="mt-1 text-[1.25rem] font-bold text-white">Log in to your account</h1>
          </div>
          <div className="bg-white border border-[#E2E8F0] rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.1)] p-6 lg:p-5">
            <form onSubmit={handleSubmit} className="space-y-3 lg:space-y-2.5">
              <button type="submit" className="w-full rounded-[6px] bg-[#3B82F6] hover:bg-[#2563EB] text-white font-bold py-3 transition-colors">Log In</button>
              ...
              <div className="rounded-[6px] border border-[#E2E8F0] bg-white/60 backdrop-blur-sm p-3 text-center">
                <p className="text-xs text-[#64748B] mb-2">New here?</p>
                <a href="/signup" className="inline-flex items-center justify-center rounded-[6px] bg-[#0F172A] text-white px-4 py-2 text-xs font-medium hover:bg-black/90">Create Account</a>
              </div>
            </form>
          </div>
